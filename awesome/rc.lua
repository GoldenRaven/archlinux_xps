...
run_once({ "unclutter -root", "keynav", "xrdb -merge ~/.Xresources"}) -- entries must be comma-separated
-- }}}

-- {{{ Variable definitions
local chosen_theme = "powerarrow"
-- local chosen_theme = "copland", "multicolor", "powerarrow"
local modkey       = "Mod4"
local altkey       = "Mod1"
...
--              {description = "decrease master width factor", group = "layout"}),
    ...
    awful.key({ modkey,           }, "s", function () awful.spawn(screenshot) end,
              {description = "deepin-screenshot", group = "launcher"}),
